    ...
    <div>
      ...
      <style>
        {`
          ...
          transition: box-shadow 0.3s ease, transform 0.3s ease; /* Hover effect transitions */
        }
        ...
        .modal-content {
          ...
          backdrop-filter: blur(10px); /* Frosted glass effect */
          -webkit-backdrop-filter: blur(10px); /* For Safari */
          border: 1px solid rgba(255, 255, 255, 0.3); /* Subtle glassmorphic border */
          border-radius: 10px; /* Rounded corners */
          width: 400px;
          padding: 20px;
          box-shadow: 0 8px 32px rgba(0, 0, 0, 0.25); /* Depth-enhancing shadow */
