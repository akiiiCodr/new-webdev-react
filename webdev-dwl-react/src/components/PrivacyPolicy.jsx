...
const PrivacyPolicy = () => {
   ...
   useEffect(() => {
      // Dynamically set the background image for the body
      document.body.style.backgroundImage = `url(${bgimage})`;
      document.body.style.backgroundSize = "cover"; // Ensures the image covers the whole background
      document.body.style.backgroundPosition = "center"; // Centers the background image
      document.body.style.backgroundAttachment = "fixed"; // Ensures the background is fixed while scrolling
